...
export const ROUTES: RouteSpec[] = [
  ...
  org("settings/impact", "GET", ADMIN, { permission: "settings:update" }),
  ...
  org("auto-schedule", "POST", MANAGER, { suspension: true, permission: "schedule:generate" }),
  org("auto-schedule/confirm", "POST", MANAGER, { suspension: true, permission: "schedule:generate" }),
  ...
  org("availability/overrides/[overrideId]", "PATCH", MEMBER, { extraParams: ["overrideId"] }),
  org("availability/overrides/[overrideId]", "DELETE", MEMBER, { extraParams: ["overrideId"] }),
  org("calendar/coverage", "GET", MANAGER, { permission: "calendar:view" }),
  org("calendar/staff", "GET", MANAGER, { permission: "calendar:view" }),
  org("calendar-settings", "GET", MANAGER, { permission: "calendar:view" }),
